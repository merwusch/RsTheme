                ...
                ?>
                    <div class="shadow p-3 mb-5 bg-body rounded-square">
                        <div class="card1  p-2 border-0 position-relative ">
                            <div>
                            <img src="img/<?php echo $post_image; ?>" class="card-img-top position-relative rounded-square" alt="...">
                                <button type=" submit " class=" btn btn-gradiental rounded-pill px-3 py-2 position-absolute text-light " style="bottom: 20px; right: 20px;"><?php echo $post_category; ?></button>
                            </div>
                            <div class="card-body">
