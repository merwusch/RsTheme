            ...
            <section>
                <div class=" row py-5 " style="padding-bottom: 1%;">
                    ...
                    <div class=" col-md-12 col-lg-3 col-xl-3 col-12  footer px-5 ">
                        ...
                        <section class=" mb-4 ">
                            <!-- Facebook -->
                            <a class=" btn btn-light btn-floating m-1 " href=" #! " role=" button "><i class=" fab fa-facebook-f " style="color: black;"></i></a>
                            <!-- Twitter -->
                            <a class=" btn btn-light btn-floating m-1 " href=" #! " role=" button "><i class=" fab fa-twitter " style="color: black;"></i></a>
                            <!-- Google -->
                            <a class=" btn btn-light btn-floating m-1 " href=" #! " role=" button "><i class=" fab fa-google " style="color: black;"></i></a>
                            <!-- Instagram -->
                            <a class=" btn btn-light btn-floating m-1 " href=" #! " role=" button "><i class=" fab fa-instagram " style="color: black;"></i></a>
                            <!-- Linkedin -->
                            <a class=" btn btn-light btn-floating m-1 " href=" #! " role=" button "><i class=" fab fa-linkedin-in " style="color: black;"></i></a>
                            <!-- Github -->
                            <a class=" btn btn-light btn-floating m-1 " href=" #! " role=" button "><i class=" fab fa-github " style="color: black;"></i></a>
                        </section>
                        <!-- Social Media end -->
                    </div>
                    <!-- Grid column -->
